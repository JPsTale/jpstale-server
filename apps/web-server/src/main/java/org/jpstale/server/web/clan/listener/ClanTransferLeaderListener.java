...
public class ClanTransferLeaderListener extends ClanMessageListener {
    ...
    public ClanTransferLeaderListener(ClanManager clanManager) {
        super(clanManager);
    }

    @Override
    public String getType() {
        return ClanMessageTypes.CLAN_TRANSFER_LEADER;
    }
    ...
    protected void handle(String data) {
        ...
        report("转让会长", clanManager.transferLeader(d.getClanName(), d.getCharName(), d.getTargetName()));
    }
}
