...
public class GameMessageSender implements MessageSender {
    ...
    @Override
    public void sendToPlayer(long playerId, ServerMessage message) {
    ...
    @Override
    public void broadcastToMap(int mapId, ServerMessage message) {
    ...
    @Override
    public void broadcastToArea(int mapId, float centerX, float centerZ, float range, ServerMessage message) {
    ...
    @Override
    public void multicast(List<Long> playerIds, ServerMessage message) {
